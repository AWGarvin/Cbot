...
class craigItem:
    def __init__(self, cPag, city, minDate, upDte):
        ...
        self.setDate()
    def getTitle(self):
        return str("".join(str(self.title)))
    def getPrice(self):
        return str("".join(str(self.price)))
    def getDescr(self):
        return str("".join(str(self.descr)))
    def getEmail(self):
        return str("".join(str(self.email)))
    def getPhone(self):
        return str("".join(str(self.phone)))
    def getDate(self):
